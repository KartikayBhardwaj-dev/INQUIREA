"""add_email_intelligence_metadata

Revision ID: 83dcc5d88c20
Revises: d1d9ef284361
Create Date: 2026-07-08 15:53:17.558787
...
revision: str = '83dcc5d88c20'
down_revision: Union[str, Sequence[str], None] = 'd1d9ef284361'
...
def upgrade() -> None:
    ...
    op.create_index(op.f('ix_email_intelligence_category'), 'email_intelligence', ['category'], unique=False)
    op.create_index(op.f('ix_email_intelligence_priority'), 'email_intelligence', ['priority'], unique=False)
...
def downgrade() -> None:
    """Downgrade schema."""
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_index(op.f('ix_email_intelligence_priority'), table_name='email_intelligence')
    op.drop_index(op.f('ix_email_intelligence_category'), table_name='email_intelligence')
