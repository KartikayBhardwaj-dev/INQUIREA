...
""",
    ...
    async def plan(self, question: str, conversation: list[dict] | None = None) -> QueryPlan:
        # Format conversational context into a linear string readable by the system node
        ...
        chain = self.prompt.partial(format_instructions=self.parser.get_format_instructions()) | llm | self.parser
